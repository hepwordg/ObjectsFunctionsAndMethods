...
def try_methods_and_functions():
    ...
    draw_many_squares(n, 2, 100, 30)

    n.speed = 5

    n.pen = rg.Pen('red', 5)

    draw_many_squares(n, 10, 50, 15)

    n.speed = 100

    n.pen = rg.Pen('blue', 35)

    draw_many_squares(n, 8, 300, 60)

    n.pen = rg.Pen('black', 3)
